...
class LoginScreenWindow(QMainWindow):
    ...
    def __init__(self,widget,FrontPageUI):
        ...
        RegisUi.HomeBtn.clicked.connect(lambda: self.GoToWindow(FrontPageUI(0)))
        RegisUi.SignInBtn.clicked.connect(lambda: self.GoToWindow(LoginScreenWindow(self.widget,\
            self.FrontPageUI)))
